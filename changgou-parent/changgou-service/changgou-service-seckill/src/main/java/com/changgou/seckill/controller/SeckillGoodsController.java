...
public class SeckillGoodsController {
    ...
    public Result<SeckillGoods> one(String time,Long id){
        ...
        return new Result<SeckillGoods>(true,StatusCode.OK,"根据ID查询秒杀商品成功！",seckillGoods);
    }
    ...
    public Result<List<SeckillGoods>> list(String time){
        ...
        return new Result<List<SeckillGoods>>(true,StatusCode.OK,"查询秒杀商品成功!",seckillGoods);
    }
